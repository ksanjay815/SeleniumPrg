...
public class frames {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath(".//*[@id='rso']/li/div/table/tbody/tr[2]/td[1]/div/span/h3/a")).click(); // click
																												// on
																												// 1st
																												// link
																												// of
																												...
																												// of
																												// india'
		// driver.findElement(By.xpath("html/body/table/tbody/tr[1]/td/table/tbody/tr/td[2]/a
		// ']")).click(); //click on 'click here to go to timesofindia.com'
		driver.findElement(By.xpath(".//*[@id='header']/div[1]/div/div/span[2]/span[1]")).click(); // click on 'Login'
																									// button
		driver.switchTo().frame(driver.findElement(By.xpath(".//*[@id='loginbox']/form"))); // now switch to login frame
																							// which has 3 options
		...
		driver.switchTo().frame(driver.findElement(By.xpath("//iframe[@id='signupsso']"))); // again switch to login
																							// frame which has 3 options
																							// facebook, twitter and
																							// your email
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath(
				"//div[ul[script[text()='sectionid=4719157']]]//a[@href='/india/indiaarticlelist/-2128936835.cms']"))
				.click(); // click on india
		driver.close();
	}
